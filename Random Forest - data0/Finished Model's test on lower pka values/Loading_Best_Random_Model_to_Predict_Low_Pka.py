...
input_csv_path = "../../data/available-amine-pka-lessthan7-dataset.csv"
sigma_profiles_dir = "../../data/SigmaProfileData/SigmaProfileData"
output_csv_path = "./predicted_low_pka_values.csv"
metrics_output_path = "./prediction_low_pka_metrics.txt"
plot_output_path = "./low_pka_actual_vs_predicted.png"
...
for _, row in molecule_data.iterrows():
    ...
    if os.path.exists(sigma_file_path):
        sigma_profile = pd.read_csv(sigma_file_path, sep=r'\s+', header=None, usecols=[1])
