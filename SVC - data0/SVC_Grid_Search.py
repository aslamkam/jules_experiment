...
param_grid = {
    'svc__C': [0.01, 0.1, 1, 10],                # Regularization strengths
    'svc__gamma': [0.001, 0.01, 0.1, 1],        # Kernel coefficients
    'svc__class_weight': [{0: 1, 1: 1}, {0: 1.5, 1: 1}, {0: 2, 1: 1}],
    'svc__kernel': ['rbf'],                     # Keep RBF kernel
    'svc__decision_function_shape': ['ovr']     # Decision function shape
}
...
best_params = {key.replace('svc__', ''): value for key, value in grid_search.best_params_.items()}
