...
# Create a pipeline with scaling and SVC using fixed parameters
pipeline = Pipeline([
...
# Train the model
best_model = pipeline.fit(X_train_smote, y_train_smote)

# Save the model
model_path = 'svc_model_sigma_pka_classification_smote_fixed.joblib'
joblib.dump(pipeline, model_path)
print(f"\nSVC model saved to '{model_path}'")
